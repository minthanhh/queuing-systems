            ...
            <div className="flex items-start">
                <div className="md:flex gap-6 mx-6 mb-8 w-full">
                    <div className="bg-white rounded-lg shadow-lg p-3 w-full md:w-1/3 flex-col flex-1">
                        <h5 className="text-primaryColor text-xl leading-[30px] font-bold mb-3">Thông tin dịch vụ</h5>
                        ...
                        <h5 className="text-primaryColor font-bold text-xl leading-[30px] mb-3">Quy tắc cấp số</h5>

                        <div className="flex flex-col gap-3 pb-[calc(258px_-_32px)]">
                            <div className="flex items-center gap-[15px]">
                                <div className="flex items-center gap-1">
                                    <span className="font-semibold text-base leading-6">Tăng tự động:</span>
                                </div>
                            ...
                            {service?.prefix ? (
                                <div className="flex items-center gap-[15px]">
                                    <div className="flex items-center">
                                        <span className="font-semibold text-base leading-6">Prefix:</span>
                                    </div>
                                    <div className="flex items-center">
                                        <input
                                            type="number"
                    ...
                    <div className="w-full md:w-4/6 bg-white shadow-lg px-6 py-4 rounded-md">
                        <Table data={orderAndState} columns={columns} className="pl-0" isLoading={isLoading} pageSize={8} />
                    </div>
                </div>

                <Manager label="Cập nhật dịch vụ" icon={EditIcon} path={'/services/update-service/' + serviceId} />
            </div>
        </div>
    )
}
