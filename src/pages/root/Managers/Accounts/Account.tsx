    ...
    const columns = useMemo<ColumnDef<IAccount>[]>(
        () => [
            ...
            },
            {
                accessorKey: 'update',
                header: '',
                cell: (cell) => ActionUpdate(cell, 'setting-systems/manager-accounts/update-account'),
            },
        ],
        [],
    )
    ...
    return (
        <div className="w-full mt-4">
            ...
            <div className="w-full flex items-start gap-6">
                <Table data={accounts} columns={columns} globalFilter={globalFilter} onGlobalFilterChange={setGlobalFilter} isLoading={isLoading} />
                ...
                {isLoading ? (
                    ...
                    <Manager icon={AddSquare} label="Thêm tài khoản" path="/setting-systems/manager-accounts/add-account" />
                )}
            </div>
        </div>
    )
