    ...
    const columns = useMemo<ColumnDef<IRole>[]>(
        () => [
            ...
            },
            {
                accessorKey: 'update',
                header: '',
                cell: (cell) => ActionUpdate(cell, 'setting-systems/manager-roles/update-role'),
            },
        ],
        [],
    )
    ...
    return (
        <div className="w-full mt-4">
            ...
            <div className="w-full flex items-start gap-6">
                <Table data={roles} columns={columns} onGlobalFilterChange={setGlobalFilter} globalFilter={globalFilter} isLoading={isLoading} />
                ...
                {isLoading ? (
                    ...
                    <Manager icon={AddSquare} label="Thêm vai trò" path="/setting-systems/manager-roles/add-role" />
                )}
            </div>
        </div>
    )
