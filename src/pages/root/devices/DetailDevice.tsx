      ...
      <div className="pl-6 mb-[50px]">
         ...
         <div className="flex gap-7">
            <div className="bg-white rounded-lg shadow-md w-full px-6 py-4">
               <h5 className="text-primaryColor leading-[30px] font-bold text-xl mb-5">
                  Thông tin thiết bị
               </h5>
               ...
               <div className="flex items-center justify-between max-w-[800px]">
                  <div className="flex flex-col">
                     <div className="flex items-center justify-between gap-[43px] mb-4">
                        <h6 className="leading-6 font-semibold text-base text-[#282739]">
                           Mã thiết bị:
                        </h6>
                        <span className="text-[#535261] uppercase leading-6 font-normal text-base">
                           {detail?.id}
                        </span>
                     </div>
                     <div className="flex items-center justify-between gap-[43px] mb-4">
                     ...
                     <div className="flex items-center justify-between gap-[43px] mb-4">
                        ...
                        <span className="text-[#535261] leading-6 font-normal text-base">
                           {detail?.addressIP}
                        </span>
                     </div>
                  </div>
               ...
               <div>
                  <h6 className="text-base leading-6 font-semibold text-[#282739]">
                     Dịch vụ sử dụng:
                  </h6>
                  <p className="text-[#535261]">
